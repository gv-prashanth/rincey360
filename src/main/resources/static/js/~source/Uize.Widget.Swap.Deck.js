...
/*?
	Introduction
		...
		*DEVELOPERS:* `Chris van Rensburg`
		...
		The =Uize.Widget.Swap.Deck= module defines the =Uize.Widget.Swap.Deck= widget class, a subclass of =Uize.Widget.Swap=. As a subclass of =Uize.Widget.Swap=, this class employs the same underlying swap transition effect mechanism. Consequently, effects settings defined in the =Uize.Widget.Swap.xPresets= extension module, and that can be used with the =Uize.Widget.Swap.Html=, =Uize.Widget.Swap.Image=, and other subclasses of the =Uize.Widget.Swap= base class, can also be used with this class. The animated swap effect can be configured by set-get properties of the class to achieve a wide variety of different transition effects.
			...
			_class.registerProperties ({
				...
				_totalItems:{
					...
					onChange:function () {
						var
							_this = this,
							_itemNodeNames = _this._itemNodeNames = []
						;
						for (var _itemNo = -1, _totalItems = _this._totalItems; ++_itemNo < _totalItems;)
							_itemNodeNames.push (_this._getItemNodeName (_itemNo))
						;
					},
					value:0
					/*?
