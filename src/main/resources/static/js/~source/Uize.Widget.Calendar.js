...
Uize.module ({
	...
	builder:function (_superclass) {
		...
		/*** Register Properties ***/
			function _updateValidDateRange () {
				this.set ({
					validDateRange:_class.copyInto (this._validDateRange || {},{start:this._minValue,end:this._maxValue})
				})
			}
			...
			_class.registerProperties ({
				...
				_maxValue:{
					...
					onChange:[_snapView,_updateUiGrid,_updateUiNavButtonsState,_updateValidDateRange]
					/*?
						Set-get Properties
							maxValue
				...
				_validDateRange:{
					name:'validDateRange',
					onChange:function () {
						var _validDateRange = this._validDateRange;
						this.set ({
							minValue:_validDateRange ? _validDateRange.start : _null,
							maxValue:_validDateRange ? _validDateRange.end : _null
						});
					}
					/*?
						Set-get Properties
							validDateRange -- DEPRECATED 2009-09-09
