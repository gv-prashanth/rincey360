	...
	builder:function (_superclass) {
		...
		/*** Private Instance Methods ***/
			_classPrototype._fadeToNewState = function (_suppressFade) {
				var
					...
					_fadeProperties = _class.copyInto ({},_this._fadeProperties,_suppressFade ? {duration:0} : null),
				...
				function _fadePanelNode (_maximized,_revealed) {
					...
					_this.setNodeStyle (_panelNode,_class.pairUp (_edge,-50000));
					...
					return Uize.Fx.fadeStyle (
						...
						_class.pairUp (_edge,0),
						0,
						_class.copyInto (_fadeProperties,{reverse:!_revealed})
					);
				}
		...
		/*** Register Properties ***/
			_class.registerProperties ({
				...
				_fadeProperties:{
					name:'fadeProperties',
					value:{duration:200,deceleration:1}
					/*?
						Set-get Properties
							fadeProperties
								document...
