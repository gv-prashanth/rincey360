...
/*?
	Introduction
		...
		*DEVELOPERS:* `Tim Carter`, `Ben Ilegbodu`, `Chris van Rensburg`, `Irena Pashchenki`

		The =Uize.Widget.TextInput= module defines the =Uize.Widget.TextInput= widget class, a subclass of =Uize.Widget=.
*/
						...
						(
							...
							(
								_validator instanceof RegExp
									...
									: (typeof _validator == 'function' ? _validator (_value) : _value == _validator)
							)
						),
