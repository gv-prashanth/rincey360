	...
	builder:function (_superclass) {
				...
				if (_this.isWired) {
					/*** set CSS class for root node ***/
						_this.setNodeProperties (
							'',
							{
								className:
									_this._cssClassBase + ' ' +
									((_this._selected ? _this._cssClassActive : _this._over && _this._cssClassOver) || '')
							}
							/*?
								Implied Nodes
									Root Node
					...
					/*** set CSS class for preview node ***/
						...
						typeof _cssClassImage == 'string' && typeof _cssClassImageOver == 'string' &&
							_this.setNodeProperties (
								'preview',
								{className:_this._over ? _cssClassImageOver : _cssClassImage}
								/*?
									Implied Nodes
										preview
		...
		/*** Public Instance Methods ***/
			...
			_classPrototype.wireUi = function () {
				var _this = this;
				if (!_this.isWired) {
					_this._cssClassBase || _this.set ({_cssClassBase:_this.getNode ().className});
