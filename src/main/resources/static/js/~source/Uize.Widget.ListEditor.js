...
/*?
	Introduction
		...
		*DEVELOPERS:* `Ben Ilegbodu`, `Chris van Rensburg`, original code donated by `Zazzle Inc.`
		...
		The =Uize.Widget.ListEditor= module defines the =Uize.Widget.ListEditor= widget class, a subclass of =Uize.Widget=.
		...
		/*** Private Instance Methods ***/
			...
			_classPrototype._sortList = function (_list) {
				...
				if (_sort != 'prepend' && _sort != 'append') {
					var _sortFunction = typeof _sort == 'function'
						? _sort
						...
						Set-get Properties
							list
								...
								Automatically Sorted
									...
									In the above example, the =sort= property of the instance =myListEditor= is set to ='a-z'=. Now, when the =set= statement is issued to set the value of the =list= property to =['c','b','a']=, the value is sorted alphanumerically in ascending order. So, after the =set= statement has executed, the value of the =list= property will actually be =['a','b','c']=.
					...
					/*?
						Set-get Properties
							sort
								...
								- ='a-z'= - the list is sorted alphanumerically, in ascending order
								- ='z-a'= - the list is sorted alphanumerically, in descending order
