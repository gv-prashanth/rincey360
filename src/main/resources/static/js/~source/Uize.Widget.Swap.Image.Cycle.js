...
/*?
	Introduction
		...
		*DEVELOPERS:* `Chris van Rensburg`
		...
		The =Uize.Widget.Swap.Image.Cycle= module defines the =Uize.Widget.Swap.Image.Cycle= widget class, a subclass of =Uize.Widget.Swap.Image= that adds the ability to specify a set of image URLs and have the widget automatically cycle through the images, with a configurable time interval between consecutive images, and the option of cycling through a set of swap effect settings so that each image is revealed with a different effect.
*/
