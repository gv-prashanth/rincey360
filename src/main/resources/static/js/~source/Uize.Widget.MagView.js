	...
	builder:function (_superclass) {
				...
				_class = _superclass.subclass (
					function () {
						...
						/*** create the fade instance ***/
							if (Uize.Fade) _this._fade = new Uize.Fade ({duration:450,acceleration:0,deceleration:1});
		...
		/*** Private Instance Methods ***/
			...
			_classPrototype._getMagImageHighResUrl = function (_magPower) {
				...
				return (
					typeof _magImageHighResUrl == 'function'
			...
			_classPrototype._updateUiDuringUse = function () {
				var
					_this = this,
					_alignX = _class.constrain ((_this._eventAbsPos.left - _this._regViewX - _this._highlightOffsetX) / _this._regViewWidthMinusHighlightWidth,0,1),
					_alignY = _class.constrain ((_this._eventAbsPos.top - _this._regViewY - _this._highlightOffsetY) / _this._regViewHeightMinusHighlightHeight,0,1),
