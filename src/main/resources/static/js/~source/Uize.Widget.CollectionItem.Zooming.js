	...
	builder:function (_superclass) {
		...
		/*** Private Instance Methods ***/
			_classPrototype._getPreviewZoomUrl = function () {
				...
				if (typeof _previewZoomUrl == 'function')
					_previewZoomUrl = _previewZoomUrl.call (this)
				;
				return _previewZoomUrl;
			};
							...
							if (_this._zoomPower > 1) {
								...
								/*** wire up document mousemove event ***/
									function _handleMouseMove () {
										...
										_this.set ({_alignX:_getAlignForAxis (0),_alignY:_getAlignForAxis (1)});
									}
									_handleMouseMove ();
		...
		/*** Register Properties ***/
			_class.registerProperties ({
				...
				_zoomFadeProperties:{
					...
					value:{duration:600,acceleration:0,deceleration:1}
					/*?
						Set-get Properties
							zoomFadeProperties
