...
/*?
	Introduction
		...
		*DEVELOPERS:* `Chris van Rensburg`, with thanks to `Robert Penner` for his easing equations work
		...
		The =Uize.Curve.Rubber= module is a package under the =Uize.Curve= namespace, and defines various "rubbery" easing curve function generators, some of which are based on the easing equations work of `Robert Penner`.
