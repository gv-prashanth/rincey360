...
/*?
	Introduction
		...
		*DEVELOPERS:* `Chris van Rensburg`
		...
		The =Uize.Widget.ImagePort= module defines the =Uize.Widget.ImagePort= widget class, a subclass of =Uize.Widget= that supports such logical sizing behaviors as fit and fill, and such logical positioning behaviors as left, center, and right aligned, or top, center, and bottom aligned, among others.
*/
