...
/*?
	Introduction
		...
		*DEVELOPERS:* `Chris van Rensburg`
		...
		The =Uize.Widget.HoverFader= module defines the =Uize.Widget.HoverFader= widget class, a subclass of =Uize.Widget=.
		...
		Fading CSS Style Properties
			...
			Configurable fade properties let you control the rate of the fade-in independently of the rate of the fade-out, and any other set-get properties of the =Uize.Fade= class (such as =acceleration= and =deceleration=) can be specified for both the fade-in and fade-out.
	...
	builder:function (_superclass) {
				...
				if (_this.isWired) {
					...
					Uize.Fade.fade (
						...
						_fadeProperties == null || typeof _fadeProperties != 'object'
							...
							: _class.copyInto ({quantization:1,duration:750},_fadeProperties)
					);
				}
				/*?
					Instance Methods
		...
		/*** Register Properties ***/
			function _updateResolvedFadeInFadeOutProperties () {
				...
				this._resolvedFadeIn = _fadeInOut ? _class.copyInto ({},_fadeInOut,this._fadeIn) : this._fadeIn;
				this._resolvedFadeOut = _fadeInOut
					? _class.copyInto ({},_fadeInOut,{reverse:!_fadeInOut.reverse},this._fadeOut)
					: this._fadeOut
				;
			}
					...
					/*?
						Set-get Properties
							fadeIn
								...
								If the default fade-in duration does not suit your needs, you should at least use this property to configure a suitable duration. Any valid set-get properties of the =Uize.Fade= class (such as =acceleration= and =deceleration=) can be specified in the =fadeIn= object, and these values will be applied when the fade-in starts.
					...
					/*?
						Set-get Properties
							fadeOut
								...
								If the default fade-out duration does not suit your needs, you should at least use this property to configure a suitable duration. Any valid set-get properties of the =Uize.Fade= class (such as =acceleration= and =deceleration=) can be specified in the =fadeOut= object, and these values will be applied when the fade-out starts.
