				...
				/*** compiler directives ***/
					/*** interface type directives ***/
						function required (_requiredModules) {
							if (_requiredModules) {
								if (typeof _requiredModules == _string)
									_requiredModules = _requiredModules.split (',')
								;
								for (
									var
										_requiredModuleNo = -1,
										_requiredModulesLength = _requiredModules.length,
										_requiredModuleName
									;
									++_requiredModuleNo < _requiredModulesLength;
								) {
									if (!_alreadyRequired [_requiredModuleName = _requiredModules [_requiredModuleNo]]) {
					...
					Encodings
						tagAttributeValue
							...
							Encoding
								...
								EXAMPLE 2
								............................................................
								<%= new Uize ({value:'CONTINUE >>'}) -> tagAttributeValue %>
								............................................................
					...
					Encodings
						urlPiece
							...
							Encoding
								...
								EXAMPLE 2
								....................................................
								<%= new Uize ({value:'hello, world'}) -> urlPiece %>
								....................................................
