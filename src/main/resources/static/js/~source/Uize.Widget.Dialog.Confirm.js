...
/*?
	Introduction
		...
		*DEVELOPERS:* `Chris van Rensburg`, original code donated by `Zazzle Inc.`
		...
		The =Uize.Widget.Dialog.Confirm= module defines the =Uize.Widget.Dialog.Confirm= widget class, a subclass of =Uize.Widget.Dialog=.
*/
			...
			_classPrototype._updateUiState = function () {
				this.isWired &&
					this.setNodeProperties (
						'icon',
						{className:'dialogIcon dialog' + _class.capFirstChar (this._state) + 'Icon'}
					)
				;
			};
