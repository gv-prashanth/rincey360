...
/*?
	Introduction
		...
		*DEVELOPERS:* `Chris van Rensburg`
		...
		The =Uize.Test.Uize.Data= module defines the =Uize.Test.Uize.Data= class, a subclass of the =Uize.Test= class.
*/
				...
				Uize.Test.staticMethodTests ([
					['Uize.Data.identical',[
						...
						/*** test for identical, two instances of the same object with identical values ***/
							['Test that two different Date object instances with the same date value are identical',
								[new Date (2001,8,11),new Date (2001,8,11)],
								true
							],

						/*** test for identical, two instances of the same object but with differing values ***/
							['Test that two different Date object instances with different date values are not identical',
					...
					['Uize.Data.reorderArray',[
						...
						['Test that \'jumbled\' option with one element array returns same array',[[1],'jumbled'],[1]],
						['Test that \'reverse\' option with empty array returns empty array',[[],'reverse'],[]],
						['Test that \'reverse\' option with one element array returns same array',[[1],'reverse'],[1]],
						...
						['Test that \'inside out\' option with empty array returns empty array',[[],'inside out'],[]],
						['Test that \'inside out\' option with one element array returns same array',[[1],'inside out'],[1]],
						...
						['Test that \'outside in\' option with empty array returns empty array',[[],'outside in'],[]],
						['Test that \'outside in\' option with one element array returns same array',[[1],'outside in'],[1]],
