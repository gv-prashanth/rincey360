			...
			_classPrototype.addItemWidget = function (_widgetName,_widgetProperties) {
				var
					...
					_itemWidget = _this.addChild (
						...
						_class.copyInto (_widgetProperties,_this.getItemWidgetProperties ())
					)
				;
				_itemWidget.wire ({
					'Changed.selected':
