...
/*?
	Introduction
		...
		*DEVELOPERS:* `Chris van Rensburg`, `Jan Borgersen`
		...
		The =Uize.Widget.Dialog.Form= module defines the =Uize.Widget.Dialog.Form= widget class, a subclass of =Uize.Widget.Dialog=.
*/
				...
				_class = _superclass.subclass (
					function () {
						...
						/*** initialization ***/
							...
							_this.wire ({
								'Before Show':
									function () {_setIframeUrl (typeof _this._url == 'function' ? _this._url () : _this._url)},
								'After Hide':
