...
/*?
	Introduction
		...
		*DEVELOPERS:* `Chris van Rensburg`
		...
		The =Uize.Widget.ImageWipe= module defines the =Uize.Widget.ImageWipe= widget class, a subclass of =Uize.Widget=. This widget class can be used in conjunction with the =Uize.Widget.SlideShow= class when creating slideshow experiences. A number of preset wipe effect settings are available in the =Uize.Widget.ImageWipe.xPresets= extension module.
							...
							/*?
								Instance Properties
									fade
										...
										This property allows access to the fade instance that drives the wipe animation. This allows you to modify properties of the animation, such as =acceleration=, =deceleration=, and any of the other set-get properties supported by the =Uize.Fade= class.
							*/
					...
					/*?
						Set-get Properties
							paneOrderScheme
								...
								The value for this property can be any of the values supported for the =reorderingModeSTR= parameter of the =Uize.Data.reorderArray= static method, including ='normal'=, ='reverse'=, ='jumbled'=, ='inside out'=, and ='outside in'=.
