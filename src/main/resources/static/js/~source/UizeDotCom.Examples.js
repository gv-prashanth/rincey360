	...
	builder:function () {
		return function () {
			return [
				...
				{
					path:'examples/bevel.html',
					title:'Basic Bevel',
					keywords:'Uize.Widget.Bevel',
					description:'See how a bevel overlay can be created for an image, where the thickness and opacity of the bevel can be controlled dynamically with slider widgets.',
					imageSrc:''
				},
				{
					path:'examples/color-cube.html',
					title:'Basic Color Cube',
					keywords:'color Uize.Widget.ColorCube',
				...
				},
				{
					...
					title:'Basic Mask',
					keywords:'animation widget Uize.Widget.Mask Uize.Fade.xFactory',
				...
				},
				{
					...
					title:'Basic Slider',
					keywords:'Uize.Widget.Bar.Slider',
				...
				{
					path:'examples/bevel-on-multiple-images.html',
					title:'Bevel On Multiple Images',
					keywords:'Uize.Widget.Bevel',
					description:'See how bevel overlays can be created for multiple images, where the thickness and opacity of the bevel for all images can be controlled with sliders.',
					imageSrc:''
				},
				{
					path:'examples/button.html',
					title:'Button',
					keywords:'widget Uize.Widget.Button',
				...
				{
					path:'examples/button-types.html',
					title:'Button Types',
					keywords:'Uize.Widget.Button',
					description:'See a demonstration of different HTML implementations for the basic button widget. Play with the enabled, busy, and selected states of the buttons.',
					imageSrc:''
				},
				{
					path:'examples/calendar.html',
					title:'Calendar',
					keywords:'widget Uize.Widget.Calendar',
				...
				},
				{
					...
					keywords:'form Uize.Widget.Bar.Slider',
				...
				{
					path:'examples/color-cube-with-pickers.html',
					title:'Color Cube With Color Pickers',
					keywords:'color drag-and-drop touch ipad Uize.Widget.ColorCube.Draggable',
				...
				},
				{
					...
					title:'Color Picker',
					keywords:'color touch ipad Uize.Widget.ColorPicker',
					description:'See how three RGB color picker widgets - with sliders for red, green, and blue - can be used to tweak text color, background color, and border color.',
					imageSrc:''
				},
				{
					path:'examples/color-pickers-with-gradient.html',
					title:'Color Pickers With Gradient',
					keywords:'color Uize.Widget.ColorPicker',
				...
				},
				{
					...
					keywords:'featured color Uize.Color.xUtil',
				...
				},
				{
					...
					keywords:'animation zoom Uize.Widget.CollectionItem.Zooming',
				...
				},
				{
					...
					title:'Date Picker',
					keywords:'widget form Uize.Widget.Picker.Date',
				...
				},
				{
					...
					title:'Digital Clock',
					keywords:'widget Uize.Widget.SegmentDisplay.Seven',
				...
				},
				{
					...
					keywords:'featured drag-and-drop widget Uize.Widget.Collection.Dynamic',
				...
				},
				{
					...
					keywords:'Uize.Node.VirtualEvent.Edge',
				...
				},
				{
					...
					keywords:'Uize.Fade',
					description:'Visualize how different values for the acceleration and deceleration properties affect a fade with this graphical representation using bar widgets.',
					imageSrc:''
				},
				{
				...
				},
				{
					...
					title:'Image Cycle',
					keywords:'animation Uize.Widget.Swap.Image.Cycle Uize.Widget.Swap.xPresets',
				...
				{
					path:'examples/swap-image-png.html',
					title:'Image Swap With PNG',
					keywords:'Uize.Widget.Swap.Image',
					description:'This example demonstrates that the image swap widget can perform transitions with images in the PNG format that have an alpha / transparency channel.',
					imageSrc:''
				},
				{
				...
				},
				{
					...
					keywords:'tool featured Uize.Json',
				...
				},
				{
					...
					keywords:'featured drag-and-drop widget Uize.Widget.Dialog.xResizable',
				...
				},
				{
					...
					keywords:'animation Uize.Data Uize.Widget.ThumbZoom',
				...
				},
				{
					...
					keywords:'featured animation Uize.Data Uize.Widget.Swap Uize.Widget.ThumbZoom',
				...
				},
				{
					...
					keywords:'color widget Uize.Color Uize.Widget.Bar.Slider',
				...
				},
				{
					...
					keywords:'featured drag-and-drop touch ipad color Uize.Color Uize.Widget.Bar.Slider',
				...
				},
				{
					...
					keywords:'featured animation widget slideshow Uize.Widget.ImageWipe Uize.Widget.SlideShow',
				...
				},
				{
					...
					keywords:'Uize.Widget.Bar.Slider Uize.Widget.Bar.Slider.xSkin',
				...
				},
				{
					...
					keywords:'featured widget menu Uize.Widget.Tree.List',
				...
				},
				{
					...
					keywords:'featured widget menu Uize.Widget.Tree.Menu',
				...
				},
				{
					...
					keywords:'Uize.Test Uize.Widget.Log',
					description:'See how to run the various unit tests of the UIZE JavaScript Framework. Run a unit test module and watch as the test runner chunks through its tests.',
					imageSrc:''
				},
				{
				...
				},
				{
					...
					keywords:'featured animation Uize.Widget.ImageWipe.xPresets',
					description:'See stunning image wipe animation effects you didn\'t believe possible with JavaScript. Choose from dozens of presets. Tweak values to make your own.',
					imageSrc:''
				},
				{
					path:'examples/swap-image.html',
					title:'Uize.Widget.Swap.Image',
					keywords:'animation widget Uize.Widget.Swap.Image',
					description:'See some amazing possibilities for image transitions using lightweight JavaScript animation. Play with lots of effect presets, and even make your own.',
					imageSrc:''
				},
				{
				...
				},
				{
					...
					keywords:'Uize.Node.VirtualEvent',
