...
/*?
	Introduction
		...
		*DEVELOPERS:* `Chris van Rensburg`
		...
		The =Uize.Widget= module defines the =Uize.Widget= class, a subclass of the =Uize= class.
	...
	builder:function (_superclass) {
		...
		/*** Private Instance Methods ***/
			...
			_classPrototype._tryUseConfirmInheritedFromTree = function (_mode,_params,_builtInConfirmFallback) {
				var _promptMethodName = 'show' + _class.capFirstChar (_mode);
		...
		/*** Public Instance Methods ***/
			...
			_classPrototype.localize = function (_resourceId,_substitutions,_tokenNaming) {
				...
				return (
					typeof _localizedResource == _typeFunction
						? _localizedResource.call (this,_substitutions)
						: _class.substituteInto (_localizedResource,_substitutions,_tokenNaming || '{KEY}')
				);
				/*?
					Instance Methods
						localize
			...
			_classPrototype.buildHtml = function (_alternateTemplateInput) {
				...
				if (_html != _undefined) {
					...
					*/
					...
					var
						_templateInput = _class.copyInto (
							{
								pathToResources:_this.Class.pathToResources,
								blankGif:_class.getBlankImageUrl ()
							},
							_alternateTemplateInput || _this.get ()
						),
						_typeofHtml = typeof _html
					;
					_Uize_Node.injectHtml (
						_nodeToInjectInto || document.body,
						_typeofHtml != _typeString && typeof _html.process == _typeFunction
							? _html.process.call (_this,_templateInput)
							: _class.substituteInto (
								_typeofHtml == _typeFunction ? _this._html (_templateInput) : _html,_templateInput
							),
			...
			_classPrototype.wired = function () {return this.isWired}; // DEPRECATED (see documentation)
			...
			/*** UI Node Methods ***/
					...
					/*?
						Instance Methods
							injectNodeHtml
								...
								SYNTAX
								........................................................................
								myWidget.injectNodeHtml (impliedNodeSTRorBLOB,htmlSTR,injectionModeSTR);
								........................................................................
								...
								When no =injectionModeSTR= parameter is specified, then the default injection mode ='inner bottom'= will be used.
				...
				_classPrototype.wireNodeEvent = // DEPRECATED (see documentation)
				_classPrototype.wireNodeEvents = // DEPRECATED (see documentation)
				...
				_classPrototype.unwireNodeEvent = // DEPRECATED (see documentation)
			...
			/*** Hierarchy Related Methods ***/
				_classPrototype.addChild = function (_childName,_childInstanceOrClass,_properties) {
					...
					var
						...
						_child = _class.isInstance (_childInstanceOrClass) ? _childInstanceOrClass : _null,
				...
				_classPrototype.removeChild = function (_childNameOrInstance) {
					var
						...
						_childName =
							typeof _childNameOrInstance == _typeString || _class.isNumber (_childNameOrInstance)
			...
			/*** Overridable Wiring and Updating Methods ***/
				_classPrototype.kill = function () {
					_class.callOn (this._children,'kill');
				...
				_classPrototype.removeUi = function () {
					...
					_class.callOn (this._children,'removeUi');
				...
				_classPrototype.unwireUi = function () {
					if (this.isWired) {
						...
						this.unwireNode ();
						_class.callOn (this._children,'unwireUi');
							...
							? (
								_instance = _parent.addChild (
									_node.id.slice (0,_parentIdPrefixPlusLength) == _parentIdPrefixPlus
										...
										: 'generatedChildName' + _class.getGuid (),
									_this,
									_properties
								)
							)
		...
		/*** Register Properties ***/
			_class.registerProperties ({
				...
				_busyInherited:{
					name:'busyInherited',
					onChange:function () {_class.callOn (this._children,_classPrototype._checkBusyInherited)},
					value:_false
					/*?
						Set-get Properties
							busyInherited
				...
				_enabledInherited:{
					...
					onChange:function () {_class.callOn (this._children,_classPrototype._checkEnabledInherited)},
					value:_true
					/*?
						Set-get Properties
							enabledInherited
					...
					/*?
						Set-get Properties
							insertionMode
								...
								Values
									The possible values for the =insertionMode= set-get property are the same as the valid values for the =injectionModeSTR= parameter of the =Uize.Node.injectHtml= static method: ='inner bottom'=, ='inner top'=, ='outer bottom'=, ='outer top'=, ='inner replace'=, and ='outer replace'=. For a more in-depth discussion of insertion modes and how they behave, consult the reference for the =Uize.Node.injectHtml= static method.
		...
		/*** wire up some window events ***/
			if (typeof navigator != 'undefined') {
				function _wireUpWindowEvent (_windowEventName,_classEventName) {
					_Uize_Node.wire (window,_windowEventName,function () {_class.fire (_classEventName)});
				}
				_wireUpWindowEvent ('load','Document Loaded'); // DEPRECATED (see documentation)
				_wireUpWindowEvent ('unload','Document Unload'); // DEPRECATED (see documentation)
				_wireUpWindowEvent ('resize','Window Resized'); // DEPRECATED (see documentation)
				_wireUpWindowEvent ('scroll','Window Scrolled'); // DEPRECATED (see documentation)
			}

		/*?
			Deprecated Features
				Document Loaded (static event) -- DEPRECATED 2009-11-12
					This static event has been deprecated in favor of the =load= event on the =window= object, that can be wired using either the =Uize.Node.wire= method of the =Uize.Node= module, or the =wireNode= instance event of the =Uize.Widget= class.
				...
				Document Unload (static event) -- DEPRECATED 2009-11-12
					This static event has been deprecated in favor of the =unload= event on the =window= object, that can be wired using either the =Uize.Node.wire= method of the =Uize.Node= module, or the =wireNode= instance event of the =Uize.Widget= class.
					...
					Uize.Widget.wire (
						'Document Unload',
						function () {
							// do something when document unloads
						}
					);
					...........................................
				...
				unwireNodeEvent (instance method) -- DEPRECATED 2009-11-08
					This method has been deprecated in favor of the more versatile and more concisely named =unwireNode= instance method.

					INSTEAD OF...
					.............................................................................
					myWidget.unwireNodeEvent (impliedNodeSTRorOBJ,eventNameSTR,eventHandlerFUNC);
					.............................................................................

					USE...
					........................................................................
					myWidget.unwireNode (impliedNodeSTRorOBJ,eventNameSTR,eventHandlerFUNC);
					........................................................................

					INSTEAD OF...
					............................................................
					myWidget.unwireNodeEvent (impliedNodeSTRorOBJ,eventNameSTR);
					............................................................

					USE...
					.......................................................
					myWidget.unwireNode (impliedNodeSTRorOBJ,eventNameSTR);
					.......................................................

					INSTEAD OF...
					...............................................
					myWidget.unwireNodeEvent (impliedNodeSTRorOBJ);
					...............................................

					USE...
					..........................................
					myWidget.unwireNode (impliedNodeSTRorOBJ);
					..........................................

					INSTEAD OF...
					............................
					myWidget.unwireNodeEvent ();
					............................
				...
				Window Resized (static event) -- DEPRECATED 2009-11-12
					This static event has been deprecated in favor of the =resize= event on the =window= object, that can be wired using either the =Uize.Node.wire= method of the =Uize.Node= module, or the =wireNode= instance event of the =Uize.Widget= class.
				...
				Window Scrolled (static event) -- DEPRECATED 2009-11-12
					This static event has been deprecated in favor of the =scroll= event on the =window= object, that can be wired using either the =Uize.Node.wire= method of the =Uize.Node= module, or the =wireNode= instance event of the =Uize.Widget= class.
				...
				wired (instance method) -- DEPRECATED 2009-06-26
					This method has been deprecated in favor of the =isWired= instance property and the =wired= set-get property.
				...
				wireNodeEvent (instance method) -- DEPRECATED 2009-11-08
					This method has been deprecated in favor of the more versatile and more concisely named =wireNode= instance method.

					INSTEAD OF...
					............................................................................
					myWidget.wireNodeEvent (impliedNodeSTRorBLOB,eventNameSTR,eventHandlerFUNC);
					............................................................................
				...
				wireNodeEvents (instance method) -- DEPRECATED 2009-11-08
					This method has been deprecated in favor of the more versatile and more concisely named =wireNode= instance method.

					INSTEAD OF...
					..........................................................................
					myWidget.wireNodeEvents (impliedNodeSTRorBLOB,eventNamesToHandlersMapOBJ);
					..........................................................................
