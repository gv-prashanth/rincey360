...
/*?
	Introduction
		...
		*DEVELOPERS:* `Chris van Rensburg`
		...
		The =Uize.Widget.ImagePort.Draggable= module defines the =Uize.Widget.ImagePort.Draggable= widget class, a subclass of =Uize.Widget.ImagePort=.
*/
