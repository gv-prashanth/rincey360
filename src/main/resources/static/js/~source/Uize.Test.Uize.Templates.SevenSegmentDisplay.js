...
/*?
	Introduction
		...
		*DEVELOPERS:* `Chris van Rensburg`
		...
		The =Uize.Test.Uize.Templates.SevenSegmentDisplay= module defines the =Uize.Test.Uize.Templates.SevenSegmentDisplay= class, a subclass of the =Uize.Test= class.
*/
