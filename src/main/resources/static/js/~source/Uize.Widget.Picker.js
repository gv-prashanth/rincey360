...
/*?
	Introduction
		...
		*DEVELOPERS:* `Chris van Rensburg`
		...
		The =Uize.Widget.Picker= module defines the =Uize.Widget.Picker= widget class, a subclass of =Uize.Widget=.
					...
					function () {
						...
						function _pickValue () {
							...
							function _possiblyFocus () {
								_this._allowManualEntry && _this.focus ();
							}
						...
						/*** watch focus by user ***/
							_this.wire ('Focus',function () {!_this._allowManualEntry && _pickValue ()});
